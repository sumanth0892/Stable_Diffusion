"""
Convert the inputs into tokens for the attention mechanism, especially the text input
"""
import json
import functools
import regex as re
...
class Tokenizer:
	def __init__(self):
		...
		self.eos_token = self.vocab["<|startoftext|>"]
